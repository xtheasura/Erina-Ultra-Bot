...
def _eufm(message: Message) -> Tuple[int, str, Union[Chat, User]]:
    ...
    if message.from_user:
        andiamsenpai = message.from_user
        user_id = andiamsenpai.id
        user_first_name = andiamsenpai.first_name

    elif message.sender_chat:
        andiamsenpai = message.sender_chat
        user_id = andiamsenpai.id
        user_first_name = andiamsenpai.title

    return (user_id, user_first_name, andiamsenpai)
